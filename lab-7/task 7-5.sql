...
ROLLBACK;
/*Вывод: y некоторых объектов окупаемость возрастает, а у других, наоборот, снижается
Если рассматривать случай, приведенный в скрипте, то окупаемость возрасла.*/